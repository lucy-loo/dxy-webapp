...
module.exports = {
  ...
  output: {
    ...
    path: path.resolve(__dirname, 'docs/assets/dll'),
    // 指定文件名
  ...
  plugins: [
    ...
    //   dry: true, // 模拟删除
    //   verbose: true, // 写入日志
    //   cleanOnceBeforeBuildPatterns: [path.resolve(__dirname, 'docs/assets/dll')],
    // }),
    new CleanWebpackPlugin(),
    ...
    new webpack.DllPlugin({
      ...
      // 由于每次打包生产环境时会清空 dist 文件夹，因此这里我将它们存放在了 public 文件夹下
      path: path.join(__dirname, 'docs/assets/dll', '[name].manifest.json'),
